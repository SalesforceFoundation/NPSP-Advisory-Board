...
The charter and all documentation behind the NPSP Advisory Board, the selection criteria and process, and the output of meetings will be public and available for comment.
...
As more partners and organizations are utilizing the NPSP, it is important that everybody trusts the application will behave in a predictable manner. Guidelines, standard API’s, and roadmap visibility are key tenants to insure transparency and help others plan their product roadmaps and release schedules. We want the NPSP Advisory Board and the community as a whole to help define the specifics of these criteria. General items that we think are important to discuss include: use of standard APIs, repositories, quality guidelines, upstream contribution models, and alternative distributions.

##### 1.1.5  Facilitate Community

The NPSP project was started in 2007 at the Salesforce Foundation (now known publicly as Salesforce.org), and since that time has been primarily driven by Salesforce.org assets and efforts.  Salesforce.org believes by letting the direction be driven by the community, we will future-proof the project and eliminate the perception that the project direction is dictated solely by Salesforce.org. We would like the NPSP Advisory Board to provide input on this to ensure there is a clear model for contribution, a meritocracy-based path for consideration in input and roadmap direction, and a well-defined model for making decisions within the core contributor team and for maintaining a high level of quality on the project.
...
*	Roadmap discussions. Salesforce.org wants partners, customers and contributors engaged in roadmap discussions and values information on how and when Advisory Board need certain technologies/features as well as input on what is most relevant on the roadmap.
...
*	Intended to serve as an authoritative governance board. The NPSP Advisory Board advises, but does not manage the NPSP project core committers, Salesforce.org product direction, or the overall NPSP team leadership.
...
#### 6.4
The NPSP Advisory Board is being formed at the discretion of Salesforce.org. Salesforce.org alone may decide to terminate the NPSP Advisory Board in its sole discretion; provided however, that Salesforce.org shall first consult the NPSP Advisory Board and Facilitator.
...
Please provide feedback on this charter by sending your comments and feedback to kbromer@salesforce.com.
